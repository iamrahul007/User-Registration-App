...
class RegistrationApp(App):
    def build(self):
        ...
        passsword_label = Label(text="Password:", font_size=18)
        ...
        # Button
        submit_button = Button(text='Register', font_size=20, on_press=self.register)
        ...
        layout.add_widget(passsword_label)
